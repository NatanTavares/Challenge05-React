...
const mockedGetByUIDReturn = {
  ...
  last_publication_date: '2021-04-19T18:49:28+0000',
  data: {
...
const mockedPaginationReturn = {
  prevPost: null,

  nextPost: {
    title: 'Criando um app CRA do zero',
    href: '/post/criando-um-app-cra-do-zero',
  },
};
...
describe('Post', () => {
  ...
  it('should be able to render post document info', () => {
    ...
    const paginationProps = mockedPaginationReturn;

    render(<Post post={postProps} pagination={paginationProps} />);
